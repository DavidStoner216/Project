...
*/
{
    ...
    if (note >= 90 && note <= 100) {
        document.getElementById("text").innerHTML = 'Nota A';
    }
    else if (note >= 80 && note <= 89) {
        document.getElementById("text").innerHTML = 'Nota B';
    }
    else if (note >= 70 && note <= 79) {
        document.getElementById("text").innerHTML = 'Nota C';
    }
    else if (note >= 60 && note <= 69) {
        document.getElementById("text").innerHTML = 'Nota D';
    }
    else if (note < 60 && note >= 0) {
        document.getElementById("text").innerHTML = 'Nota F';
    }
    else
        document.getElementById("text").innerHTML = 'Nota invalida';
}
...
// Outra forma de se fazer com If Else
{
    ...
    document.getElementById("text").innerHTML = getScore(score);
...

{
    ...
    document.getElementById("text").innerHTML = (transformeDegree('2c'));
}
